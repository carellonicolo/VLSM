...
Applicare il VLSM alla rete 172.29.0.0/22 per soddisfare i requisiti indicati.
...
Applicare il VLSM alla rete 10.58.0.0/21 per soddisfare i requisiti indicati.
Ordinare le sottoreti dalla più grande alla più piccola e completare la tabella di allocazione.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 10.38.0.0/20.
...
### b) *(2 pt)* — Identificare i blocchi non allocati nel blocco `10.38.0.0/20` ed esprimerli in notazione CIDR.
