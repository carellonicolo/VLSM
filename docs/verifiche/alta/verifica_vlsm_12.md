...
Applicare il VLSM alla rete 172.27.0.0/17 per soddisfare i requisiti indicati.
...
Applicare il VLSM alla rete 10.60.0.0/21 per soddisfare i requisiti indicati.
Ordinare le sottoreti dalla più grande alla più piccola e completare la tabella di allocazione.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 172.30.0.0/16.
...
### b) *(1 pt)* — Identificare i blocchi non allocati nel blocco `172.30.0.0/16` ed esprimerli in notazione CIDR.
