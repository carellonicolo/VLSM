...
Applicare il VLSM alla rete 10.96.0.0/11 per soddisfare i requisiti indicati.
...
Applicare il VLSM alla rete 10.80.0.0/16 per soddisfare i requisiti indicati.
Ordinare le sottoreti dalla più grande alla più piccola e completare la tabella di allocazione.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 172.16.0.0/14.
