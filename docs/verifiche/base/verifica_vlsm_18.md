...
Applicare il VLSM alla rete 192.168.70.0/24 per soddisfare i requisiti indicati.
...
Applicare il VLSM alla rete 172.16.24.0/22 per soddisfare i requisiti indicati.
Ordinare le sottoreti dalla più grande alla più piccola e completare la tabella di allocazione.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 10.11.0.0/21.
...
### b) *(2 pt)* — Identificare i blocchi non allocati nel blocco `10.11.0.0/21` ed esprimerli in notazione CIDR.
