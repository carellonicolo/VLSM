...
Applicare il VLSM alla rete 172.45.0.0/20 per soddisfare i requisiti indicati.
Ordinare le sottoreti dalla più grande alla più piccola e completare la tabella di allocazione.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 10.36.0.0/17.
...
### b) *(1 pt)* — Identificare i blocchi non allocati nel blocco `10.36.0.0/17` ed esprimerli in notazione CIDR.
