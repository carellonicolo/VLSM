...
Applicare il VLSM alla rete 10.50.0.0/19 per soddisfare i requisiti indicati.
...
Applicare il VLSM alla rete 172.32.16.0/20 per soddisfare i requisiti indicati.
Ordinare le sottoreti dalla più grande alla più piccola e completare la tabella di allocazione.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 10.46.0.0/17.
...
### b) *(1 pt)* — Identificare i blocchi non allocati nel blocco `10.46.0.0/17` ed esprimerli in notazione CIDR.
...
### c) *(1 pt)* — È richiesta una nuova sottorete per **1300 host**. Scegliere il blocco residuo più adatto e compilare la riga seguente.
