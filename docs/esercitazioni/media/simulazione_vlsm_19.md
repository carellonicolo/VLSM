...
Applicare il VLSM alla rete 10.29.0.0/23 per soddisfare i requisiti indicati.
...
Applicare il VLSM alla rete 172.36.8.0/22 per soddisfare i requisiti indicati.
Ordinare le sottoreti dalla più grande alla più piccola e completare la tabella di allocazione.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 172.26.0.0/19.
...
### b) *(2 pt)* — Identificare i blocchi non allocati nel blocco `172.26.0.0/19` ed esprimerli in notazione CIDR.
...
### c) *(1 pt)* — È richiesta una nuova sottorete per **450 host**. Scegliere il blocco residuo più adatto e compilare la riga seguente.
