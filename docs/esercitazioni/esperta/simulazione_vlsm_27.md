...
Applicare il VLSM alla rete 10.224.0.0/11 per soddisfare i requisiti indicati.
...
Un amministratore ha allocato le seguenti sottoreti all'interno del blocco 172.32.0.0/14.
...
### b) *(1 pt)* — Identificare i blocchi non allocati nel blocco `172.32.0.0/14` ed esprimerli in notazione CIDR.
